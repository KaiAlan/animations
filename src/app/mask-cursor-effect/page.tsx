      ...
      <div className="flex flex-col justify-start items-start h-full w-full gap-3 mt-6">
        <div className="flex flex-col justify-start items-start pb-10 md:pb-16 gap-3">
          ...
          <div className="flex gap-2">
            ...
            <Badge
              variant="outline"
              className="hover:bg-gray-500 hover:bg-opacity-20 p-2 cursor-pointer"
            >
              Framer Motion
            </Badge>
            <Badge
          ...
          <div className="flex justify-start items-center gap-1">
            <Link href="https://github.com/KaiAlan/animations">
              <svg
            ...
            <Link href="https://twitter.com/KaiAlan_">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
        ...
        <div className="flex flex-col justify-center items-start w-1/2 gap-2">
          <p className="font-semibold text-xl">
            A special thanks 🤗 to Olivier Larose for his great tutorials
          </p>
          <p className="font-thin text-sm">
            His tutorials are really awesome and easy to understand. If you also
            wanted to get started with this kind of animations I would highly
            suggest his great blogs. You can find them here :
            <Link
              href="https://blog.olivierlarose.com/"
              className="text-sm font-bold text-blue-600 hover:underline cursor-pointer p-2"
            >
              Olivier Larose
            </Link>
          </p>
